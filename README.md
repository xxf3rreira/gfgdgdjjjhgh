if (game:GetService("CoreGui")):FindFirstChild("FerreiraHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).FerreiraHub:Destroy();
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("FerreiraHub")).Enabled = not (game.CoreGui:FindFirstChild("FerreiraHub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("FerreiraHub") then
			makefolder("FerreiraHub");
		end;
		if not isfolder("FerreiraHub/Library/") then
			makefolder("FerreiraHub/Library/");
		end;
		if not isfile(("FerreiraHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("FerreiraHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("FerreiraHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("FerreiraHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("FerreiraHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local FerreiraHub = Instance.new("ScreenGui");
	FerreiraHub.Name = "FerreiraHub";
	FerreiraHub.Parent = game.CoreGui;
	FerreiraHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = FerreiraHub;
	...
	CreateButton("Reset Config", function()
		if isfolder("FerreiraHub") then
			delfolder("FerreiraHub");
		end;
